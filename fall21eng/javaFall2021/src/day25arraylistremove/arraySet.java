...
public class arraySet {
	...
	// verilen arraydan tekrar eden elemenetleri sadece birer tane yazarak unıg elemnetlerden bir aray haline getirelim 
	...
	for (int i = 0; i < arr1.length; i++) {
		if (!tekrarsız.contains(arr1[i])) {
			tekrarsız.add(arr1[i]);
		}
	...
	int arr2[]= new int[tekrarsız.size()];
