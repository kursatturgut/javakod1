...
/*
	...
	Rýdvan Adaklý  11:14 PM
	*/
	
	// tek seferde olmasý için tüm hatalarý baþtan söylemeli
	
	Scanner scan=new Scanner(System.in);
	System.out.println("lütfen sifre giriniz");
	String sifre = "";
	kuçukharf(sifre, scan);
    boolean a=false;
	...
	private static boolean kuçukharf(String sifre, Scanner scan) {
		boolean a=false;
		sifre=scan.nextLine();
		String kharf="abcdefghýijklmnoöprþtuüvyz";
